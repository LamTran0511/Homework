create database ss8_k1;
create schema ss8_k1;
set search_path to ss8_k1;
...
-- Tham số total: tổng giá trị đơn hàng
    create procedure calculate_oder_total(order_id_input int, out total numeric)
language plpgsql
as $$
    begin
...
call calculate_oder_total(102,null)
