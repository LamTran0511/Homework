create database PhanTichDoanhDB;
create schema PhanTichDoanh;
set search_path to phantichdoanh;
...
having sum(o.total_price) = (select max(city_revenue)
                             from (select SUM(o.total_price) as city_revenue
                                   from customers c
